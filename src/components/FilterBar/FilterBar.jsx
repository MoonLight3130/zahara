  ...
  <div className="mb-8">
    <div className="flex flex-col lg:flex-row gap-4 items-stretch lg:items-center">
      <div className="relative flex-1">
        <FiSearch className="absolute left-4 top-1/2 -translate-y-1/2 text-gold/60" />
        <input
          type="text"
          placeholder="Search jewellery..."
          value={filters.search}
          onChange={(e) => onChange({ ...filters, search: e.target.value })}
          className="w-full pl-12 pr-4 py-3 bg-charcoal border border-white/10 rounded-2xl text-white placeholder:text-white/40 focus:outline-none focus:border-gold/50 transition-colors"
        />
      </div>
      ...
      <button
        ...
        className="lg:hidden flex items-center justify-center gap-2 px-4 py-3 border border-gold/30 rounded-2xl text-gold"
      >
        <FiSliders /> Filters
      </button>
