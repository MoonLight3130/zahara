      ...
      <div className="w-full text-left mb-4">
        ...
        <div className="relative flex items-center group">
          ...
          <input
            ...
            className={`w-full ${Icon ? 'pl-11' : 'pl-4'} pr-4 py-3.5 text-white text-base rounded-xl border outline-none transition-all duration-300 placeholder:text-white/25 ${
              error
